...
.field public final MODEL_E1:I

.field public final MODEL_E2:I

.field public final MODEL_E3:I
...
.field public final MODEL_Q5_MAIN:I

.field public final MODEL_Q5_SUB:I
...
.method public static constructor <clinit>()V
    ...
    const-string v0, "BURN_IN_POC_APPLY_COUNT"

    const-string v1, "BURN_IN_JND"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v6, v1, v8}, Lcom/samsung/android/hardware/display/AfterimageCompensationService$ScreenWatchingReceiver;-><init>(Lcom/samsung/android/hardware/display/AfterimageCompensationService;Lcom/samsung/android/hardware/display/AfterimageCompensationService$ScreenWatchingReceiver-IA;)V
    ...
    const-string/jumbo v5, "mAfcType : "
    ...
    iget v6, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcSize:I

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v6, ", mAfpcHeight : "

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcHeight:I
    ...
    const-string/jumbo v6, "mAfpcPanelNumber_sub : "

    invoke-virtual {v4, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcPanelNumber_sub:I
    ...
    iget v6, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcSize_sub:I
    ...
    iget v6, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcWidth_sub:I
    ...
    iget v15, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcHeight:I

    iget v14, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcWidth:I
    ...
    iget v8, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcPanelNumber_sub:I

    iget v14, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcSize_sub:I

    iget v15, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcHeight_sub:I

    iget v3, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcWidth_sub:I
    ...
    iget v8, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mApplyValue:F
    ...
    iget v3, v1, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAfpcSize:I
...
.method public final updateHWParam()V
    ...
    iget v1, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mApplyValue:F

    invoke-static {v1}, Ljava/lang/Float;->toString(F)Ljava/lang/String;

    move-result-object v3

    iget-wide v4, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAvgLum:D

    invoke-static {v4, v5}, Ljava/lang/Double;->toString(D)Ljava/lang/String;

    move-result-object v4

    iget-wide v5, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mMaxBDI:D

    invoke-static {v5, v6}, Ljava/lang/Double;->toString(D)Ljava/lang/String;

    move-result-object v5

    iget-wide v6, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mNBDI:D

    invoke-static {v6, v7}, Ljava/lang/Double;->toString(D)Ljava/lang/String;

    move-result-object v6

    iget-wide v7, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mEffAvgLum:D

    invoke-static {v7, v8}, Ljava/lang/Double;->toString(D)Ljava/lang/String;

    move-result-object v7

    iget-wide v8, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mEffMaxBDI:D

    invoke-static {v8, v9}, Ljava/lang/Double;->toString(D)Ljava/lang/String;

    move-result-object v8

    iget-wide v9, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mEffNBDI:D
    ...
    iget v1, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mApplyValue_sub:F

    invoke-static {v1}, Ljava/lang/Float;->toString(F)Ljava/lang/String;

    move-result-object v11

    iget-wide v12, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mAvgLum_sub:D

    invoke-static {v12, v13}, Ljava/lang/Double;->toString(D)Ljava/lang/String;

    move-result-object v12

    iget-wide v13, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mMaxBDI_sub:D

    invoke-static {v13, v14}, Ljava/lang/Double;->toString(D)Ljava/lang/String;

    move-result-object v13

    iget-wide v14, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mNBDI_sub:D
    ...
    iget-wide v14, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mEffAvgLum_sub:D
    ...
    iget-wide v14, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mEffMaxBDI_sub:D

    invoke-static {v14, v15}, Ljava/lang/Double;->toString(D)Ljava/lang/String;

    move-result-object v17

    iget-wide v14, v0, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->mEffNBDI_sub:D
    ...
    invoke-virtual {v0, v2, v1, v3}, Lcom/samsung/android/hardware/display/AfterimageCompensationService;->parseBigData([Ljava/lang/String;[Ljava/lang/String;I)Ljava/lang/String;
...
.method public final update_check_panel_id()V
    ...
    const-string/jumbo v2, "update_cell_id() function start"
