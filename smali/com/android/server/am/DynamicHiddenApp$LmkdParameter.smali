...
.method public static synthetic $values()[Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;
    ...
    sget-object v3, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_DEBUG:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;
    ...
    sget-object v5, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_UPGRADE_PRESSURE:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v6, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_DOWNGRADE_PRESSURE:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v7, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_KILL_HEAVIEST_TASK:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v8, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_KILL_TIMEOUT_MS:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v9, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_USE_MINFREE_LEVELS:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v10, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_ENABLE_USERSPACE_LMK:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v11, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_ENABLE_CMARBINFREE_SUB:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v12, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_ENABLE_UPGRADE_CRIADJ:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;
    ...
    sget-object v14, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_FREELIMIT_VAL:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v15, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_PSI_LOW_TH:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v16, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_PSI_MEDIUM_TH:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v17, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_PSI_CRITICAL_TH:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v18, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_SET_SWAPTOTAL:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    sget-object v19, Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;->LMK_SET_BG_KEEPING:Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;

    filled-new-array/range {v0 .. v19}, [Lcom/android/server/am/DynamicHiddenApp$LmkdParameter;
