...
.method public final deliverToRegisteredReceiverLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;ZI)V
    ...
    .line 886
    iget-object v4, v14, Lcom/android/server/am/BroadcastRecord;->callerApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v5, v15, Lcom/android/server/am/BroadcastQueue;->mQueueName:Ljava/lang/String;

    iget v6, v13, Lcom/android/server/am/BroadcastFilter;->owningUserId:I

    const/16 v24, 0x1

    iget-object v7, v14, Lcom/android/server/am/BroadcastRecord;->mBackgroundStartPrivileges:Landroid/app/BackgroundStartPrivileges;

    .line 892
    invoke-virtual {v7}, Landroid/app/BackgroundStartPrivileges;->allowsAny()Z
    ...
    .line 891
    invoke-virtual/range {v16 .. v25}, Lcom/android/server/am/BaseRestrictionMgr;->isRestrictedPackage(Landroid/content/ComponentName;Ljava/lang/String;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;IZZ)Z
    ...
    iput-object v14, v4, Lcom/android/server/am/ReceiverList;->curBroadcast:Lcom/android/server/am/BroadcastRecord;

    .line 919
    iput v3, v14, Lcom/android/server/am/BroadcastRecord;->state:I

    .line 920
    iget-object v3, v4, Lcom/android/server/am/ReceiverList;->app:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v4, v14, Lcom/android/server/am/BroadcastRecord;->curApp:Lcom/android/server/am/ProcessRecord;

    invoke-virtual {v3, v4}, Lcom/android/server/am/ActivityManagerService;->enqueueOomAdjTargetLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-virtual {v4, v3, v0}, Lcom/android/server/am/OomAdjuster;->unfreezeTemporarily(Lcom/android/server/am/ProcessRecord;I)V
...
.method public processNextBroadcastLocked(ZZ)V
    ...
    invoke-virtual {v11, v6, v7}, Lcom/android/server/am/ActivityManagerService;->getProcessRecordLocked(Ljava/lang/String;I)Lcom/android/server/am/ProcessRecord;
    ...
    .line 1469
    iget-object v12, v10, Lcom/android/server/am/BroadcastRecord;->filterExtrasForReceiver:Ljava/util/function/BiFunction;
    ...
    invoke-interface {v13, v14, v12}, Ljava/util/function/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v3, v10, Lcom/android/server/am/BroadcastRecord;->userId:I

    invoke-virtual {v11, v12, v13, v3}, Lcom/android/server/am/MARsPolicyManager;->onSpecialIntentActions(Ljava/lang/String;Landroid/content/Intent;I)V
    ...
    .line 1489
    iget-object v11, v10, Lcom/android/server/am/BroadcastRecord;->callerApp:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v9, v8, Lcom/android/server/am/BroadcastQueue;->mQueueName:Ljava/lang/String;
    ...
    iget-object v2, v10, Lcom/android/server/am/BroadcastRecord;->mBackgroundStartPrivileges:Landroid/app/BackgroundStartPrivileges;
    ...
    .line 1494
    invoke-virtual/range {v11 .. v20}, Lcom/android/server/am/BaseRestrictionMgr;->isRestrictedPackage(Landroid/content/ComponentName;Ljava/lang/String;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;IZZ)Z
    ...
    const-string v11, " is skipped in RestrictedPackage to "
    ...
    .line 1520
    iget v9, v10, Lcom/android/server/am/BroadcastRecord;->manifestCount:I

    add-int/2addr v9, v2

    iput v9, v10, Lcom/android/server/am/BroadcastRecord;->manifestCount:I

    .line 1522
    iget-object v9, v10, Lcom/android/server/am/BroadcastRecord;->delivery:[I
    ...
    .line 1526
    iput-object v6, v10, Lcom/android/server/am/BroadcastRecord;->curFilteredExtras:Landroid/os/Bundle;
    ...
    .line 1539
    invoke-virtual {v0, v2, v5, v6}, Landroid/app/usage/UsageStatsManagerInternal;->reportEvent(Ljava/lang/String;II)V
    ...
    .line 1545
    invoke-virtual {v0, v2, v6, v5}, Landroid/content/pm/PackageManagerInternal;->setPackageStoppedState(Ljava/lang/String;ZI)V
    :try_end_8
    ...
    invoke-virtual {v3, v2, v5, v6, v0}, Lcom/android/server/am/ProcessRecord;->addPackage(Ljava/lang/String;JLcom/android/server/am/ProcessStatsService;)Z

    .line 1557
    invoke-virtual {v8, v3, v10}, Lcom/android/server/am/BroadcastQueueImpl;->maybeAddBackgroundStartPrivileges(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)V

    const/4 v2, 0x1

    .line 1558
    iput-boolean v2, v10, Lcom/android/server/am/BroadcastRecord;->mIsReceiverAppRunning:Z

    .line 1559
    invoke-virtual {v8, v10, v3}, Lcom/android/server/am/BroadcastQueueImpl;->processCurBroadcastLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    :try_end_9
    ...
    .line 1565
    invoke-virtual {v3, v0, v2, v5, v6}, Lcom/android/server/am/ProcessRecord;->killLocked(Ljava/lang/String;IIZ)V
    ...
    invoke-direct {v0, v2, v3, v5, v9}, Lcom/android/server/am/HostingRecord;-><init>(Ljava/lang/String;Landroid/content/ComponentName;Ljava/lang/String;Ljava/lang/String;)V
