...
.method public sendInner(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Landroid/content/IIntentReceiver;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IIILandroid/os/Bundle;II)I
    ...
    .line 526
    invoke-virtual {v11, v13}, Landroid/content/Intent;->setRemoteAppLaunch(Z)V
    ...
    .line 533
    invoke-virtual {v5}, Landroid/app/ActivityOptions;->getPendingIntentLaunchFlags()I
    ...
    .line 550
    :goto_8
    sget-boolean v7, Lcom/samsung/android/rune/CoreRune;->FW_APPLOCK:Z
    :try_end_2
    ...
    invoke-direct {v0, v5}, Lcom/android/server/wm/SafeActivityOptions;-><init>(Landroid/app/ActivityOptions;)V

    goto :goto_a

    .line 564
    :cond_11
    invoke-virtual {v0, v5}, Lcom/android/server/wm/SafeActivityOptions;->setCallerOptions(Landroid/app/ActivityOptions;)V
    ...
    iget v9, v8, Lcom/android/server/am/PendingIntentRecord$Key;->type:I
    ...
    invoke-static {v8, v10, v6, v10, v13}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    .line 586
    invoke-virtual {v8, v13}, Landroid/content/Intent;->setRemoteAppLaunch(Z)V
    ...
    invoke-virtual {v3, v14, v13}, Landroid/app/ActivityManagerInternal;->enforceBroadcastOptionsPermissions(Landroid/os/Bundle;I)V
    ...
    .line 629
    iget-object v6, v5, Lcom/android/server/am/PendingIntentRecord$TempAllowListDuration;->reason:Ljava/lang/String;
    ...
    iget v12, v15, Lcom/android/server/am/PendingIntentRecord;->uid:I

    move-object/from16 v37, v11

    iget-wide v10, v5, Lcom/android/server/am/PendingIntentRecord$TempAllowListDuration;->duration:J

    iget v3, v5, Lcom/android/server/am/PendingIntentRecord$TempAllowListDuration;->type:I
    ...
    .line 751
    invoke-virtual {v15, v0, v2, v14, v13}, Lcom/android/server/am/PendingIntentRecord;->getBackgroundStartPrivilegesForActivitySender(Landroid/util/ArraySet;Landroid/os/IBinder;Landroid/os/Bundle;I)Landroid/app/BackgroundStartPrivileges;
