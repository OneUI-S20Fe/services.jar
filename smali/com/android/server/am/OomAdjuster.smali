...
.method public final applyOomAdjLSP(Lcom/android/server/am/ProcessRecord;ZJJI)Z
    ...
    .line 3395
    iget-object v10, v2, Lcom/android/server/am/ProcessRecord;->mState:Lcom/android/server/am/ProcessStateRecord;
    ...
    invoke-virtual {v10, v3}, Lcom/android/server/am/ProcessStateRecord;->setSetRawAdj(I)V
    ...
    .line 3418
    invoke-virtual/range {v3 .. v11}, Lcom/android/server/chimera/PerProcessNandswap;->onOomAdjChanged(ILjava/lang/String;IIIZJ)I
    ...
    .line 3430
    invoke-virtual {v14, v3}, Lcom/android/server/am/ProcessStateRecord;->setCurAdj(I)V
    ...
    invoke-virtual {v14, v3}, Lcom/android/server/am/ProcessStateRecord;->setCurRawAdj(I)V
    ...
    :cond_3
    :goto_0
    iget-object v4, v1, Lcom/android/server/am/OomAdjuster;->mGPUMemoryReclaimer:Lcom/android/server/chimera/GPUMemoryReclaimer;
    ...
    .line 3438
    invoke-virtual/range {v4 .. v10}, Lcom/android/server/chimera/GPUMemoryReclaimer;->onOomAdjChanged(ILjava/lang/String;IIZZ)V
    ...
    invoke-static {v3, v4, v5, v15}, Lcom/android/server/am/ProcessList;->setOomAdj(IIII)V
    ...
    invoke-virtual {v14, v3}, Lcom/android/server/am/ProcessStateRecord;->setSetAdj(I)V
    ...
    .line 3462
    invoke-virtual {v14, v0}, Lcom/android/server/am/ProcessStateRecord;->setVerifiedAdj(I)V
    ...
    invoke-static {v0, v3, v4, v15}, Lcom/android/server/am/ProcessList;->setOomAdj(IIII)V
    ...
    .line 3477
    invoke-virtual {v14, v3}, Lcom/android/server/am/ProcessStateRecord;->setSetSchedGroup(I)V
    ...
    .line 3530
    :cond_13
    iget-object v7, v1, Lcom/android/server/am/OomAdjuster;->mCFMS:Landroid/os/ICustomFrequencyManager;
    ...
    .line 3533
    invoke-static {v7}, Landroid/os/ICustomFrequencyManager$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/ICustomFrequencyManager;

    move-result-object v7

    iput-object v7, v1, Lcom/android/server/am/OomAdjuster;->mCFMS:Landroid/os/ICustomFrequencyManager;
    ...
    const-string v15, "SLOWDOWN::OOM Request PID = "
    ...
    invoke-interface {v7, v8, v0, v15}, Landroid/os/ICustomFrequencyManager;->requestFreezeSlowdown(IZLjava/lang/String;)I
    :try_end_0
    ...
    .line 3546
    invoke-virtual {v0, v9, v7, v6, v8}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/am/ProcessStateRecord;->setSavedPriority(I)V
    ...
    .line 3559
    invoke-static {v6, v11}, Lcom/android/server/am/ActivityManagerService;->scheduleAsFifoPriority(IZ)Z
    ...
    invoke-virtual {v14}, Lcom/android/server/am/ProcessStateRecord;->getSavedPriority()I
    ...
    .line 3592
    invoke-static {v6, v9, v9}, Landroid/os/Process;->setThreadScheduler(III)V
    :try_end_4
    ...
    .line 3618
    :goto_8
    invoke-virtual {v14}, Lcom/android/server/am/ProcessStateRecord;->hasRepForegroundActivities()Z
    ...
    invoke-virtual {v14, v3}, Lcom/android/server/am/ProcessStateRecord;->setRepForegroundActivities(Z)V
    ...
    invoke-virtual {v14, v3}, Lcom/android/server/am/ProcessStateRecord;->setReportedProcState(I)V
    ...
    :cond_20
    :goto_a
    invoke-virtual {v14, v12, v13}, Lcom/android/server/am/ProcessStateRecord;->setLastStateTime(J)V
    ...
    .line 3670
    invoke-virtual {v14, v12, v13}, Lcom/android/server/am/ProcessStateRecord;->setWhenUnimportant(J)V
    ...
    .line 3677
    invoke-virtual {v1, v10, v12, v13}, Lcom/android/server/am/OomAdjuster;->maybeUpdateLastTopTime(Lcom/android/server/am/ProcessStateRecord;J)V
    ...
    invoke-virtual {v10, v3}, Lcom/android/server/am/ProcessStateRecord;->setSetProcState(I)V
    ...
    .line 3681
    invoke-virtual {v10, v9}, Lcom/android/server/am/ProcessStateRecord;->setNotCachedSinceIdle(Z)V
    ...
    .line 3689
    :cond_26
    invoke-virtual {v10, v11}, Lcom/android/server/am/ProcessStateRecord;->setProcStateChanged(Z)V
    ...
    .line 3691
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->hasReportedInteraction()Z
    ...
    .line 3699
    :goto_e
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->getInteractionEventTime()J
    ...
    .line 3709
    :goto_f
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->getFgInteractionTime()J
    ...
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->getSetCapability()I
    ...
    invoke-virtual {v10, v3}, Lcom/android/server/am/ProcessStateRecord;->setSetCapability(I)V

    .line 3718
    :cond_2c
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->isCurBoundByNonBgRestrictedApp()Z

    move-result v3

    .line 3719
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->isSetBoundByNonBgRestrictedApp()Z
    ...
    .line 3720
    invoke-virtual {v10, v3}, Lcom/android/server/am/ProcessStateRecord;->setSetBoundByNonBgRestrictedApp(Z)V

    if-nez v3, :cond_2d

    .line 3721
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->isBackgroundRestricted()Z
    ...
    .line 3738
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->hasRepForegroundActivities()Z
    ...
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->shouldNotKillOnBgRestrictedAndIdle()Z
    ...
    .line 3761
    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->isSetCached()Z

    move-result v2

    if-eqz v2, :cond_2f

    invoke-virtual {v10}, Lcom/android/server/am/ProcessStateRecord;->isSetNoKillOnBgRestrictedAndIdle()Z
    ...
    .line 3764
    :cond_2f
    invoke-virtual {v10, v11, v12}, Lcom/android/server/am/ProcessStateRecord;->setLastCanKillOnBgRestrictedAndIdleTime(J)V
    ...
    invoke-virtual {v10, v1}, Lcom/android/server/am/ProcessStateRecord;->setSetCached(Z)V
    ...
    invoke-virtual {v10, v1}, Lcom/android/server/am/ProcessStateRecord;->setSetNoKillOnBgRestrictedAndIdle(Z)V
...
.method public final computeOomAdjLSP(Lcom/android/server/am/ProcessRecord;ILcom/android/server/am/ProcessRecord;ZJZZ)Z
    ...
    .line 2265
    iget-object v1, v9, Lcom/android/server/am/OomAdjuster;->mTmpComputeOomAdjWindowCallback:Lcom/android/server/am/OomAdjuster$ComputeOomAdjWindowCallback;
    ...
    const-string v0, "fg-service-short"
    ...
    iget-wide v0, v0, Lcom/android/server/am/ActivityManagerConstants;->TOP_TO_FGS_GRACE_DURATION:J
    ...
    iget-wide v0, v0, Lcom/android/server/am/ActivityManagerConstants;->TOP_TO_ALMOST_PERCEPTIBLE_GRACE_DURATION:J
    ...
    sget-wide v41, Lcom/android/server/am/ActivityManagerConstants;->MAX_PREVIOUS_TIME:J
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/am/ProcessCachedOptimizerRecord;->setShouldNotFreeze(Z)V
    ...
    .line 2655
    :goto_2f
    invoke-virtual {v9, v4}, Lcom/android/server/am/OomAdjuster;->getBfslCapabilityFromClient(Lcom/android/server/am/ProcessRecord;)I
    ...
    .line 2706
    :cond_6e
    invoke-virtual/range {v34 .. v34}, Lcom/android/server/am/ProcessStateRecord;->hasShownUi()Z

    move-result v0

    if-eqz v0, :cond_70

    invoke-virtual/range {v34 .. v34}, Lcom/android/server/am/ProcessStateRecord;->getCachedIsHomeProcess()Z
    ...
    if-gt v7, v15, :cond_81

    if-le v1, v15, :cond_81
    ...
    .line 2807
    invoke-virtual {v3, v15}, Lcom/android/server/am/ConnectionRecord;->notHasFlag(I)Z
    ...
    .line 2842
    invoke-virtual {v6, v15}, Lcom/android/server/am/ProcessStateRecord;->getCachedCompatChange(I)Z
    ...
    .line 2845
    invoke-virtual {v3, v8}, Lcom/android/server/am/ConnectionRecord;->hasFlag(I)Z
    ...
    .line 2856
    invoke-virtual {v3, v6}, Lcom/android/server/am/ConnectionRecord;->notHasFlag(I)Z
    ...
    .line 2894
    invoke-virtual {v5, v6}, Lcom/android/server/am/ProcessStateRecord;->setAdjTypeCode(I)V
    ...
    .line 2900
    invoke-virtual {v9, v14, v2}, Lcom/android/server/am/OomAdjuster;->reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 2917
    iget-object v6, v10, Lcom/android/server/am/ProcessRecord;->mOptRecord:Lcom/android/server/am/ProcessCachedOptimizerRecord;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lcom/android/server/am/ProcessCachedOptimizerRecord;->setShouldNotFreeze(Z)V
    ...
    .line 2921
    invoke-virtual {v6, v7}, Lcom/android/server/am/ProcessServiceRecord;->setTreatLikeActivity(Z)V
    ...
    invoke-virtual {v9, v14, v1}, Lcom/android/server/am/OomAdjuster;->reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 2953
    iget-object v3, v10, Lcom/android/server/am/ProcessRecord;->mProviders:Lcom/android/server/am/ProcessProviderRecord;
    ...
    .line 2959
    :goto_4c
    invoke-virtual {v3, v6}, Lcom/android/server/am/ProcessProviderRecord;->getProviderAt(I)Lcom/android/server/am/ContentProviderRecord;
    ...
    .line 2960
    iget-object v3, v5, Lcom/android/server/am/ContentProviderRecord;->connections:Ljava/util/ArrayList;
    ...
    .line 2965
    :cond_a5
    iget-object v0, v5, Lcom/android/server/am/ContentProviderRecord;->connections:Ljava/util/ArrayList;
    ...
    .line 2967
    iget-object v11, v8, Lcom/android/server/am/ProcessRecord;->mState:Lcom/android/server/am/ProcessStateRecord;
    ...
    invoke-virtual {v11, v0}, Lcom/android/server/am/ProcessStateRecord;->setCurRawAdj(I)V
    ...
    invoke-virtual {v11, v0}, Lcom/android/server/am/ProcessStateRecord;->setCurRawProcState(I)V
    ...
    .line 2984
    invoke-virtual {v11}, Lcom/android/server/am/ProcessStateRecord;->getCurRawProcState()I
    ...
    .line 3008
    invoke-virtual/range {v31 .. v31}, Lcom/android/server/am/ProcessStateRecord;->hasShownUi()Z

    move-result v2

    if-eqz v2, :cond_ad

    invoke-virtual/range {v31 .. v31}, Lcom/android/server/am/ProcessStateRecord;->getCachedIsHomeProcess()Z
    ...
    invoke-virtual {v12, v6, v1}, Lcom/android/server/am/ContentProviderConnection;->trackProcState(II)V

    move/from16 v12, v30

    if-le v12, v6, :cond_b3
    ...
    .line 3040
    invoke-virtual {v8, v1}, Lcom/android/server/am/ProcessStateRecord;->setAdjTypeCode(I)V

    .line 3042
    invoke-virtual {v8, v14}, Lcom/android/server/am/ProcessStateRecord;->setAdjSource(Ljava/lang/Object;)V
    ...
    invoke-virtual {v8, v1}, Lcom/android/server/am/ProcessStateRecord;->setAdjTarget(Ljava/lang/Object;)V

    move/from16 v11, v54

    if-ne v15, v11, :cond_b5
    ...
    .line 3046
    invoke-virtual {v9, v14, v0}, Lcom/android/server/am/OomAdjuster;->reportOomAdjMessageLocked(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 3059
    invoke-virtual {v8, v7}, Lcom/android/server/am/ProcessStateRecord;->setCurRawAdj(I)V

    .line 3061
    invoke-virtual {v8, v7}, Lcom/android/server/am/ProcessStateRecord;->setCached(Z)V
    ...
    :goto_57
    if-le v12, v6, :cond_bc

    .line 3071
    invoke-virtual {v8, v6}, Lcom/android/server/am/ProcessStateRecord;->setCurRawProcState(I)V

    if-ne v15, v11, :cond_ba
    ...
    .line 3080
    :goto_59
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/am/ProcessProviderRecord;->getLastProviderTime()J
    ...
    iget-wide v13, v3, Lcom/android/server/am/ActivityManagerConstants;->CONTENT_PROVIDER_RETAIN_TIME:J
    ...
    .line 3103
    invoke-virtual/range {v55 .. v55}, Lcom/android/server/am/ProcessServiceRecord;->hasClientActivities()Z
    ...
    .line 3107
    :cond_c2
    invoke-virtual/range {v55 .. v55}, Lcom/android/server/am/ProcessServiceRecord;->isTreatedLikeActivity()Z
    ...
    .line 3135
    :cond_c6
    invoke-virtual {v8, v7}, Lcom/android/server/am/ProcessStateRecord;->setServiceHighRam(Z)V
    ...
    .line 3182
    invoke-virtual {v9, v4, v15, v8}, Lcom/android/server/am/OomAdjuster;->promoteSchedGroupIfNecessary(IILcom/android/server/am/ProcessStateRecord;)Z
    ...
    invoke-virtual {v5}, Lcom/android/server/am/UidRecord;->getFGSFilterStatus()Z
    ...
    invoke-virtual {v5, v7}, Lcom/android/server/am/UidRecord;->setFGSFilterStatus(Z)V

    .line 3202
    :cond_d1
    :goto_63
    invoke-virtual {v8}, Lcom/android/server/am/ProcessStateRecord;->getAbnormalStatus()Z
    ...
    .line 3214
    :cond_d2
    invoke-virtual {v8, v7}, Lcom/android/server/am/ProcessStateRecord;->setAbnormalStatus(Z)V
    ...
    .line 3221
    invoke-virtual {v8, v0}, Lcom/android/server/am/ProcessStateRecord;->setCurCapability(I)V

    .line 3222
    invoke-virtual {v8, v4}, Lcom/android/server/am/ProcessStateRecord;->setCurrentSchedulingGroup(I)V

    .line 3223
    invoke-virtual {v8, v15}, Lcom/android/server/am/ProcessStateRecord;->setCurProcState(I)V

    .line 3224
    invoke-virtual {v8, v15}, Lcom/android/server/am/ProcessStateRecord;->setCurRawProcState(I)V

    move/from16 v0, v22

    .line 3225
    invoke-virtual {v8, v0}, Lcom/android/server/am/ProcessStateRecord;->updateLastInvisibleTime(Z)V
    ...
    .line 3228
    invoke-virtual {v8, v2}, Lcom/android/server/am/ProcessStateRecord;->setCurBoundByNonBgRestrictedApp(Z)V
