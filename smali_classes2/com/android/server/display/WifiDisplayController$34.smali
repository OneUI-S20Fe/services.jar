...
.method public onDisplayConnected(Landroid/view/Surface;IIIILjava/lang/String;)V
    ...
    .line 2523
    iget-object p4, p0, Lcom/android/server/display/WifiDisplayController$34;->this$0:Lcom/android/server/display/WifiDisplayController;

    invoke-static {p4}, Lcom/android/server/display/WifiDisplayController;->-$$Nest$fgetmAdvertisedDisplay(Lcom/android/server/display/WifiDisplayController;)Landroid/hardware/display/WifiDisplay;

    move-result-object v2

    invoke-static {p4, v2, p6}, Lcom/android/server/display/WifiDisplayController;->-$$Nest$mparseParametersFromEngine(Lcom/android/server/display/WifiDisplayController;Landroid/hardware/display/WifiDisplay;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p4}, Landroid/hardware/display/WifiDisplay;->getParameters()Ljava/util/concurrent/ConcurrentHashMap;

    move-result-object p4

    .line 2525
    invoke-virtual {p4}, Ljava/util/concurrent/ConcurrentHashMap;->entrySet()Ljava/util/Set;
    ...
    invoke-direct {v2, v4, p6}, Landroid/hardware/display/SemWifiDisplayParameter;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p4, p1}, Lcom/android/server/display/WifiDisplayController;->-$$Nest$monConnectionSuccess(Lcom/android/server/display/WifiDisplayController;Ljava/util/List;)V

    .line 2529
    iget-object p4, p0, Lcom/android/server/display/WifiDisplayController$34;->this$0:Lcom/android/server/display/WifiDisplayController;

    invoke-static {p4, p1}, Lcom/android/server/display/WifiDisplayController;->-$$Nest$msendWifiDisplayParameterEvent(Lcom/android/server/display/WifiDisplayController;Ljava/util/List;)V
