...
.method public update(Lcom/android/server/pm/pkg/AndroidPackage;)V
    ...
    const-string v4, "] replaced by "

    const-string/jumbo v5, "metadata rpUID ["
    ...
    .line 73
    invoke-virtual {p1, v6, v7, v1}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 75
    invoke-virtual {p1, v7}, Landroid/content/res/Resources;->getXml(I)Landroid/content/res/XmlResourceParser;

    move-result-object v6

    .line 76
    new-instance v7, Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;

    iget-object v8, p0, Lcom/android/server/om/wallpapertheme/MetaDataManager;->mSeslMetaData:Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;

    invoke-direct {v7, p0, v6, v8}, Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;-><init>(Lcom/android/server/om/wallpapertheme/MetaDataManager;Landroid/content/res/XmlResourceParser;Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;)V

    .line 77
    invoke-virtual {v7}, Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;->getRpUID()Ljava/lang/String;

    move-result-object v6

    .line 78
    invoke-virtual {p0, v6}, Lcom/android/server/om/wallpapertheme/MetaDataManager;->removeUidMap(Ljava/lang/String;)V

    .line 79
    invoke-virtual {v7}, Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;->getCurrentPackage()Lcom/android/server/om/wallpapertheme/MetaDataManager$Package;

    move-result-object v7

    .line 80
    invoke-virtual {v7}, Lcom/android/server/om/wallpapertheme/MetaDataManager$Package;->getUidList()Ljava/util/List;
    ...
    check-cast v8, Lcom/android/server/om/wallpapertheme/MetaDataManager$Uid;

    .line 81
    iget-object v9, p0, Lcom/android/server/om/wallpapertheme/MetaDataManager;->mUidMap:Ljava/util/HashMap;

    invoke-virtual {v8}, Lcom/android/server/om/wallpapertheme/MetaDataManager$Uid;->getUidValue()Ljava/lang/String;
    ...
    .line 83
    :cond_1
    iget-object v7, p0, Lcom/android/server/om/wallpapertheme/MetaDataManager;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v9, "metadata file not found in res/xml : "
    ...
    iget-object v2, p0, Lcom/android/server/om/wallpapertheme/MetaDataManager;->mSeslMetaData:Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;

    invoke-direct {v0, p0, p1, v2}, Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;-><init>(Lcom/android/server/om/wallpapertheme/MetaDataManager;Landroid/content/res/XmlResourceParser;Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;)V

    .line 93
    invoke-virtual {v0}, Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;->getRpUID()Ljava/lang/String;
    ...
    .line 95
    invoke-virtual {v0}, Lcom/android/server/om/wallpapertheme/MetaDataManager$MetaData;->getCurrentPackage()Lcom/android/server/om/wallpapertheme/MetaDataManager$Package;
    ...
    .line 97
    iget-object v3, p0, Lcom/android/server/om/wallpapertheme/MetaDataManager;->mUidMap:Ljava/util/HashMap;

    invoke-virtual {v2}, Lcom/android/server/om/wallpapertheme/MetaDataManager$Uid;->getUidValue()Ljava/lang/String;
    ...
    .line 99
    :cond_4
    iget-object v0, p0, Lcom/android/server/om/wallpapertheme/MetaDataManager;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v1, "metadata update error = "
