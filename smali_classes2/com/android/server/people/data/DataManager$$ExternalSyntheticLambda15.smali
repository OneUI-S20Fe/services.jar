...
.method public final accept(Ljava/lang/Object;)V
    ...
    .line 0
    iget-object v0, p0, Lcom/android/server/people/data/DataManager$$ExternalSyntheticLambda15;->f$0:Lcom/android/server/people/data/DataManager;

    iget-wide v1, p0, Lcom/android/server/people/data/DataManager$$ExternalSyntheticLambda15;->f$1:J

    iget-object v3, p0, Lcom/android/server/people/data/DataManager$$ExternalSyntheticLambda15;->f$2:Lcom/android/server/people/data/ConversationStore;

    iget-object v4, p0, Lcom/android/server/people/data/DataManager$$ExternalSyntheticLambda15;->f$3:Lcom/android/server/people/data/PackageData;

    move-object v5, p1

    check-cast v5, Lcom/android/server/people/data/ConversationInfo;

    invoke-static/range {v0 .. v5}, Lcom/android/server/people/data/DataManager;->$r8$lambda$9QtnLJolnfZOyDCArzVmsAk6eIU(Lcom/android/server/people/data/DataManager;JLcom/android/server/people/data/ConversationStore;Lcom/android/server/people/data/PackageData;Lcom/android/server/people/data/ConversationInfo;)V
