.class public Lcom/android/server/notification/NotificationManagerService$24;
...
.method public constructor <init>(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;IIIIZJ)V
    ...
    iput p3, p0, Lcom/android/server/notification/NotificationManagerService$24;->val$callingUid:I

    iput p4, p0, Lcom/android/server/notification/NotificationManagerService$24;->val$callingPid:I

    iput p5, p0, Lcom/android/server/notification/NotificationManagerService$24;->val$userId:I

    iput p6, p0, Lcom/android/server/notification/NotificationManagerService$24;->val$reason:I

    iput-boolean p7, p0, Lcom/android/server/notification/NotificationManagerService$24;->val$includeCurrentProfiles:Z

    iput-wide p8, p0, Lcom/android/server/notification/NotificationManagerService$24;->val$cancellationElapsedTimeMs:J
...
.method public run()V
    ...
    iget v4, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$callingPid:I

    const/4 v5, 0x0

    iget v6, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$userId:I

    const/4 v7, 0x0

    const/4 v8, 0x0

    iget v9, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$reason:I
    ...
    iget v5, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$callingUid:I

    iget v6, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$callingPid:I
    ...
    iget-boolean v11, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$includeCurrentProfiles:Z

    iget v12, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$userId:I

    iget v14, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$reason:I
    ...
    iget-boolean v0, v0, Lcom/android/server/notification/NotificationManagerService$24;->val$includeCurrentProfiles:Z
