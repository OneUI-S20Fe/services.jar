.class public Lcom/android/server/notification/NotificationManagerService$23;
...
.method public constructor <init>(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;IILjava/lang/String;IIIIZLjava/lang/String;J)V
    ...
    iput p3, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$callingUid:I

    iput p4, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$callingPid:I

    iput-object p5, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$pkg:Ljava/lang/String;

    iput p6, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$userId:I

    iput p7, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$mustHaveFlags:I

    iput p8, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$mustNotHaveFlags:I

    iput p9, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$reason:I

    iput-boolean p10, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$doit:Z

    iput-object p11, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$channelId:Ljava/lang/String;

    iput-wide p12, p0, Lcom/android/server/notification/NotificationManagerService$23;->val$cancellationElapsedTimeMs:J
...
.method public run()V
    ...
    iget v3, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$callingPid:I

    iget-object v4, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$pkg:Ljava/lang/String;

    iget v5, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$userId:I

    iget v6, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$mustHaveFlags:I

    iget v7, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$mustNotHaveFlags:I

    iget v8, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$reason:I
    ...
    iget v3, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$mustNotHaveFlags:I

    new-instance v14, Lcom/android/server/notification/NotificationManagerService$23$$ExternalSyntheticLambda0;
    ...
    iget v4, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$callingUid:I

    iget v5, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$callingPid:I

    iget-object v6, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$pkg:Ljava/lang/String;

    const/4 v7, 0x1

    iget-object v8, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$channelId:Ljava/lang/String;

    const/4 v10, 0x0

    iget v11, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$userId:I

    iget v13, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$reason:I

    const/16 v16, 0x1

    move/from16 v18, v13

    iget-wide v12, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$cancellationElapsedTimeMs:J
    :try_end_0
    ...
    iget v2, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$userId:I

    iget-object v0, v0, Lcom/android/server/notification/NotificationManagerService$23;->val$pkg:Ljava/lang/String;
