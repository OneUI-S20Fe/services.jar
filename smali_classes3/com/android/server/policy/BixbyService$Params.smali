...
# direct methods
.method public static bridge synthetic -$$Nest$fgetdoublePress(Lcom/android/server/policy/BixbyService$Params;)Z
    .locals 0

    .line 0
    iget-boolean p0, p0, Lcom/android/server/policy/BixbyService$Params;->doublePress:Z

    return p0
.end method

.method public static bridge synthetic -$$Nest$fgetevent(Lcom/android/server/policy/BixbyService$Params;)Landroid/view/KeyEvent;
    .locals 0

    .line 0
    iget-object p0, p0, Lcom/android/server/policy/BixbyService$Params;->event:Landroid/view/KeyEvent;

    return-object p0
.end method

.method public static bridge synthetic -$$Nest$fgetinteractive(Lcom/android/server/policy/BixbyService$Params;)Z
    .locals 0

    .line 0
    iget-boolean p0, p0, Lcom/android/server/policy/BixbyService$Params;->interactive:Z

    return p0
.end method

.method public static bridge synthetic -$$Nest$fgetisPowerCombination(Lcom/android/server/policy/BixbyService$Params;)Z
    .locals 0

    .line 0
    iget-boolean p0, p0, Lcom/android/server/policy/BixbyService$Params;->isPowerCombination:Z

    return p0
.end method

.method public static bridge synthetic -$$Nest$fgetisUnlockFP(Lcom/android/server/policy/BixbyService$Params;)Z
    .locals 0

    .line 0
    iget-boolean p0, p0, Lcom/android/server/policy/BixbyService$Params;->isUnlockFP:Z

    return p0
.end method

.method public static bridge synthetic -$$Nest$fgetlongPress(Lcom/android/server/policy/BixbyService$Params;)Z
    .locals 0

    .line 0
    iget-boolean p0, p0, Lcom/android/server/policy/BixbyService$Params;->longPress:Z

    return p0
.end method

.method public static bridge synthetic -$$Nest$fgetshowToast(Lcom/android/server/policy/BixbyService$Params;)Z
    .locals 0

    .line 0
    iget-boolean p0, p0, Lcom/android/server/policy/BixbyService$Params;->showToast:Z
