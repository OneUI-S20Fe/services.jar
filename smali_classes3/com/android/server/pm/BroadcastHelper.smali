...
.method public static synthetic $r8$lambda$vXDYsrvE73Bdmd9UbIsTAwqPuUU()Ljava/lang/Boolean;
    .locals 1

    .line 0
    invoke-static {}, Lcom/android/server/pm/BroadcastHelper;->lambda$sendSessionCommitBroadcast$1()Ljava/lang/Boolean;
...
.method public sendResourcesChangedBroadcast(Ljava/util/function/Supplier;ZZ[Ljava/lang/String;[ILandroid/content/IIntentReceiver;)V
    ...
    .line 346
    new-instance v12, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda1;

    move-object v0, p1

    invoke-direct {v12, p1}, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda1;-><init>(Ljava/util/function/Supplier;)V
...
.method public sendSessionCommitBroadcast(Landroid/content/pm/PackageInstaller$SessionInfo;IILandroid/content/ComponentName;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p5, p3}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V

    .line 472
    :cond_1
    iget-object v1, p0, Lcom/android/server/pm/BroadcastHelper;->mContext:Landroid/content/Context;

    const-string v3, "com.sec.android.app.desktoplauncher"

    new-instance v6, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda0;

    invoke-direct {v6}, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda0;-><init>()V
    ...
    invoke-static/range {v1 .. v6}, Lcom/samsung/android/server/pm/desktopmode/DesktopModeUtils;->sendSessionCommitBroadcastToDesktopLauncherIfNeeded(Landroid/content/Context;Landroid/content/ComponentName;Ljava/lang/String;Landroid/content/pm/PackageInstaller$SessionInfo;ILjava/util/function/Supplier;)V
