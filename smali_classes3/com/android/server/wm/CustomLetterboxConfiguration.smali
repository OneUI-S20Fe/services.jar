...
# direct methods
.method public static synthetic $r8$lambda$EijjpWmPIeKmF6P71GEQcN371K0([ZLandroid/os/IBinder;Lcom/android/server/wm/DisplayContent;)V
    .locals 0

    .line 0
    invoke-static {p0, p1, p2}, Lcom/android/server/wm/CustomLetterboxConfiguration;->lambda$isEnhancedControllerToken$3([ZLandroid/os/IBinder;Lcom/android/server/wm/DisplayContent;)V
...
.method public static isCustomLetterboxEnabled(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-interface {p0}, Lcom/android/server/wm/BoundsCompatController;->supportsCustomLetterbox()Z
...
.method public static isEnhancedControllerToken(Landroid/os/IBinder;)Z
    ...
    iget-object v2, v2, Lcom/android/server/wm/CustomLetterboxConfiguration;->mWmService:Lcom/android/server/wm/WindowManagerService;

    iget-object v2, v2, Lcom/android/server/wm/WindowManagerService;->mRoot:Lcom/android/server/wm/RootWindowContainer;

    new-instance v3, Lcom/android/server/wm/CustomLetterboxConfiguration$$ExternalSyntheticLambda0;

    invoke-direct {v3, v0, p0}, Lcom/android/server/wm/CustomLetterboxConfiguration$$ExternalSyntheticLambda0;-><init>([ZLandroid/os/IBinder;)V
...
.method public static synthetic lambda$isEnhancedControllerToken$3([ZLandroid/os/IBinder;Lcom/android/server/wm/DisplayContent;)V
    .locals 2
    ...
    iget-object v1, v1, Lcom/android/server/wm/CustomLetterboxConfiguration;->mEnhancedControllers:Landroid/util/SparseArray;
    ...
    check-cast p2, Lcom/android/server/wm/CustomLetterboxEnhancedController;

    if-eqz p2, :cond_1

    .line 369
    invoke-virtual {p2}, Lcom/android/server/wm/CustomLetterboxEnhancedController;->isAvailable()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p2}, Lcom/android/server/wm/CustomLetterboxEnhancedController;->getToken()Landroid/os/Binder;
...
.method public static onConfigurationChanged(I)V
    ...
    invoke-direct {v2, v0, p0}, Lcom/android/server/wm/CustomLetterboxConfiguration$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/wm/CustomLetterboxConfiguration;Z)V
