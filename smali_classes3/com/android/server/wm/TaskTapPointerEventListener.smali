...
.method public final onPointerEventInner(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v2, v0, p1}, Lcom/android/server/wm/DisplayContent;->findTaskForResizePoint(II)Lcom/android/server/wm/Task;
    ...
    .line 137
    iget-object v2, p0, Lcom/android/server/wm/TaskTapPointerEventListener;->mTmpRect:Landroid/graphics/Rect;
    ...
    :cond_9
    :goto_2
    iget v2, p0, Lcom/android/server/wm/TaskTapPointerEventListener;->mPointerIconType:I
    ...
    .line 105
    :cond_d
    iget-object p1, p0, Lcom/android/server/wm/TaskTapPointerEventListener;->mTouchExcludeRegion:Landroid/graphics/Region;

    invoke-virtual {p1, v0, v2}, Landroid/graphics/Region;->contains(II)Z
    ...
    .line 106
    iget-object p1, p0, Lcom/android/server/wm/TaskTapPointerEventListener;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {p1, v1, v0, v2}, Lcom/android/server/wm/TaskPositioningController;->handleTapOutsideTask(Lcom/android/server/wm/DisplayContent;II)V
